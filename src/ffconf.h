...
#define _FS_TIMEOUT		(10*SYSTEM_TICKS_PER_SEC)	/* Timeout period in unit of time ticks */
#define	_SYNC_t			ATOM_MUTEX*	/* O/S dependent type of sync object. e.g. HANDLE, OS_EVENT*, ID and etc.. */
